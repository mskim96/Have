...
//    }
    ...
    func deleteReminder(withReminderList reminderList: ReminderList) {
        sampleData = sampleData.filter { $0.reminderListRefId != reminderList.id }
    }
    ...
    private var sampleData = [
        Reminder(
            ...
            reminderListRefId: "ReminderListMockRepository.mock.sampleDefaultReminderList"
        ),
        Reminder(
